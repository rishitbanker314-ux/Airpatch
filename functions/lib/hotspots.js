...
exports.assignReportTrigger = functions.firestore
    ...
    if (before.aiStatus !== 'completed' && after.aiStatus === 'completed') {
        ...
        const isPollution = ((_a = after.aiVerification) === null || _a === void 0 ? void 0 : _a.isPollutionEvent) === true;
        const isNotNone = ((_b = after.aiVerification) === null || _b === void 0 ? void 0 : _b.predictedCategory) !== 'none';
...
async function assignReportToHotspot(reportId, report) {
    ...
    hotspotsSnapshot.forEach(doc => {
        ...
        const dist = (0, geo_1.calculateDistanceMeters)(report.location.lat, report.location.lng, hotspot.center.lat, hotspot.center.lng);
        if (dist <= minDistance) {
            minDistance = dist;
...
async function recomputeHotspotStats(hotspotId) {
    ...
    const risk = (0, risk_1.calculateHotspotRisk)(mergedHotspot, rawReports);
